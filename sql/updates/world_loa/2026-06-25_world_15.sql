-- LOA zone port: creature_template rows for spawns on maps 860/870 missing templates.
-- Follow-up to 2026-06-25_world_11.sql (spawns were ported before templates).
-- Maps LOA schema to SkyFire (faction->faction_A/H, rank->npc_rank, drops difficulty_entry_4/5).
