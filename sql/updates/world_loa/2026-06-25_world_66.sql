-- LOA instance port: creature_template for dungeon/raid spawns missing templates.
-- See 2026-06-25_world_65.sql for map list. Status: local-only (not pushed upstream)
