-- LOA zone port: SmartAI waypoints for maps 860/870 (SkyFire uses `waypoints`, not `waypoint_data`).
-- Paths referenced by SMART_ACTION_WP_START (action_type 53, path id in action_param2).
