-- LOA zone port: smart_scripts for creatures on map 1050 (LOA has none for outdoor spawns).
-- Included for pipeline consistency; expected 0 rows. Status: local-only (not pushed upstream)
