-- LOA port: creature_model_info for models used by maps 860/870 zone port.
-- Covers models from new templates (world_15) and existing zone spawns still missing model data.
-- Also includes P0 models 47022 and 51322 (68993, 73422). Status: local-only (not pushed upstream)
